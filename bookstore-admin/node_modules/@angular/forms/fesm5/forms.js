 ...
 * to keep the view synced with the `FormControl` domain.
 *
...
var AbstractControl = /** @class */ (function () {
     ...
     * to maintain the domain, and re-calculate the `touched` status of all parent
     * controls.
     */
    /**
       * Marks the control as `untouched`.
     ...
     * to maintain the domain, and re-calculate the `pristine` status of all parent
     * controls.
     */
    /**
       * Marks the control as `pristine`.
     ...
     *
     * If the control has children, all children will be disabled to maintain the domain.
     */
    /**
       * Disables the control. This means the control will be exempt from validation checks and
       * excluded from the aggregate value of any parent. Its status is `DISABLED`.
...
var FormControl = /** @class */ (function (_super) {
     ...
     * domain.  This is the default behavior if `emitViewToModelChange` is not specified.
     */
    /**
       * Set the value of the form control to `value`.
       *
 ...
 * the rest of your form, or if some values in your domain domain make more sense to
 ...
 * @description
 *
 * Creates a `FormControl` instance from a domain domain and binds it
 * to a form control element.
 *
 * The `FormControl` instance will track the value, user interaction, and
 * validation status of the control and keep the view synced with the domain. If used
 ...
 *
 * It accepts a domain domain as an optional `Input`. If you have a one-way binding
 * to `ngModel` with `[]` syntax, changing the value of the domain domain in the component
 * class will set the value in the view. If you have a two-way binding with `[()]` syntax
 * (also known as 'banana-box syntax'), the value in the UI will always be synced back to
 * the domain domain in your class as well.
 *
 ...
 * than the domain domain's value on submit.
 *
 ...
 * instance programmatically will be written to the DOM element (domain -> view). Conversely,
 * any values written to the DOM element through user input will be reflected in the
 * `FormControl` instance (view -> domain).
 *
