...
export interface ControlValueAccessor {
     ...
     * (domain -> view) changes are requested.
     *
     ...
     * domain when values propagate from the view (view -> domain).
     *
     ...
     * a blur event.
     *
     * This is called by the forms API on initialization so it can update the form domain
     * on blur.
     *
