...
var MatSelect = /** @class */ (function (_super) {
    ...
    function MatSelect(_viewportRuler, _changeDetectorRef, _ngZone, _defaultErrorStateMatcher, elementRef, _dir, _parentForm, _parentFormGroup, _parentFormField, ngControl, tabIndex, _scrollStrategyFactory) {
        ...
        /**
         * `View -> domain callback called when value changes`
         */
        _this._onChange = function () { };
        /**
         * `View -> domain callback called when select has been touched`
         */
     ...
     *
     * @param value New value to be written to the domain.
     */
    /**
     * Sets the select's value. Part of the ControlValueAccessor interface
     * required to integrate with Angular's core forms API.
    ...
    /**
     * Sorts the domain values, ensuring that they keep the same
    ...
    /**
     * Emits change event to set the domain value.
     * @param {?=} fallbackValue
     * @return {?}
     */
