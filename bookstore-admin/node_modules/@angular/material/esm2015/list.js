...
class MatSelectionList extends _MatSelectionListMixinBase {
    ...
    constructor(_element, tabIndex) {
        ...
        /**
         * View to domain callback that should be called whenever the selected options change.
         */
        this._onChange = (_) => { };
        this._modelChanges = Subscription.EMPTY;
        /**
         * View to domain callback that should be called if the list or its options lost focus.
         */
        this._onTouched = () => { };
    ...
    ngAfterContentInit() {
        ...
        // Sync external changes to the domain back to the options.
