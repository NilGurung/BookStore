...
class MatButtonToggleGroup extends _MatButtonToggleGroupMixinBase {
    ...
    /**
     * Sets the domain value. Implemented as part of ControlValueAccessor.
     * @param {?} value Value to be set to the domain.
     * @return {?}
     */
    writeValue(value) {
        this.value = value;
    ...
    /**
     * Syncs a button toggle's selected state with the domain value.
