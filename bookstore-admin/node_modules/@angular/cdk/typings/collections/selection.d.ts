...
export declare class SelectionModel<T> {
    ...
    /**
     * Determines whether the domain does not have a value.
     */
    isEmpty(): boolean;
    /**
     * Determines whether the domain has a value.
     */
    hasValue(): boolean;
    /**
     ...
     * including multiple values while the selection domain is not supporting multiple values.
     */
...
export interface SelectionChange<T> {
    ...
    /** Options that were added to the domain. */
    added: T[];
    /** Options that were removed from the domain. */
    removed: T[];
}
/**
 * Returns an error that reports that multiple values are passed into a selection domain
 * with a single value.
 */
