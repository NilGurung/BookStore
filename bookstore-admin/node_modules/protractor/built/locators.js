 ...
 * Angular applications by binding, domain, etc.
 *
 * @alias by
...
class ProtractorBy extends WebdriverBy {
    ...
    ;
    /**
     * Find an element by ng-domain expression.
     *
     * @alias by.domain(modelName)
     * @view
     * <input type="text" ng-domain="person.name">
     *
     * @example
     * var input = element(by.domain('person.name'));
     * input.sendKeys('123');
     * expect(input.getAttribute('value')).toBe('Foo123');
     *
     * @param {string} model ng-domain expression.
     * @returns {ProtractorLocator} location strategy
     */
    model(model) {
        return {
     ...
     * @view
     * <select ng-domain="color" ng-options="c for c in colors">
